	...
	<div class="col-md-10 offset-md-1">
		<div class="card mb-3">
			...
			<div class="card-body">
				...
				<p class="card-text">
					<small class="text-body-secondary">${video.usuarioNombre}
		...
		<ul id="comentarios" class="list-group">
			<c:if test="${padre != null}">
				<li
					...
					src="https://picsum.photos/75/75?${padre.usuarioId}" alt="">
					<div
						class="flex-grow-1 d-flex justify-content-start align-items-center">
						<div class="ms-2 me-auto">
							<div class="fw-bold">${padre.usuarioNombre}</div>
						</div>
			...
			<c:forEach items="${comentarios}" var="c">
				<li
					class="pt-4 pb-5 px-4 list-group-item d-flex flex-wrap align-items-stretch">
					<img width="25" class="rounded-circle" src="https://picsum.photos/75/75?${c.usuarioId}"
					alt="">
					<div
						class="flex-grow-1 d-flex justify-content-start align-items-center">
						<div class="ms-2 me-auto">
